...
<select class="form-control" style="width: 250px;" name="category_id">
    ...
    <?php endforeach; ?>
            ...
            <div class="row" style="margin-top:5px;">
                ...
                <div class="col-md-10">
                    <input type="checkbox" <?php if(isset($record->display)&&$record->display==1): ?> checked <?php endif; ?> name="display" id="display"> <label for="display">Display</label>
                </div>
                </div>
            </div>
            <!-- end rows -->
            ...
            <!-- end rows -->
            <?php if(isset($record->photo5)&&file_exists("../assets/upload/products/".$record->photo5)): ?>
            <!-- rows -->
            <div class="row" style="margin-top:5px;">
                <div class="col-md-2"></div>
                <div class="col-md-10">
