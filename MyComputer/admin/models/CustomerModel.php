<?php 
	trait CustomerModel{
		...
		public function modelUpdate($id){
			...
			//lay bien ket noi
			$conn = Connection::getInstance();
			$query = $conn->prepare("update customers set name=:_name where id=:_id");
		...
		public function modelCreate(){
			...
			//lay bien ket noi
			$conn = Connection::getInstance();
			$query = $conn->prepare("insert into customers set name=:_name, email=:_email, password=:_password");
